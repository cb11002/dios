        ...
        <div id="content">
			...
			?>
                ...
                <header>
                   ...
                   <div class="toolbar">
				    <a href="<?php echo site_url('tutor/kelas/form_asignment/' .$Id_Class); ?>" class="btn btn-default btn-sm btn-grad btn-rect">Add Asignment</a>
...
?> 
	<tr> 
		...
		<a href="<?php echo site_url('tutor/kelas/delete_asignment/' .$dg->Id_Asignment.'/'.$dg->Id_Class); ?>" class="glyphicon glyphicon-remove" title="Delete">
