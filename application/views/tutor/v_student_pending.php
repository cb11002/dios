...
?> 
	<tr> 
		...
		<a href="<?php echo site_url('tutor/kelas/update_status_pending/' .$dg->Id_Student_Class.'/'.$dg->Id_Class); ?>" class="glyphicon glyphicon-ok" title="Approve">&nbsp;
		<a href="<?php echo site_url('tutor/kelas/update_status_reject/' .$dg->Id_Student_Class.'/'.$dg->Id_Class); ?>" class="glyphicon glyphicon-remove" title="Reject">
