...
?> 
	<tr> 
		...
		<a href="<?php echo site_url('tutor/kelas/details_kelas/' .$dg->Id_Class); ?>" class="glyphicon glyphicon-search" title="View">&nbsp;
		<a href="<?php echo site_url('tutor/kelas/delete_kelas/' .$dg->Id_Class); ?>" class="glyphicon glyphicon-remove" title="Remove">
