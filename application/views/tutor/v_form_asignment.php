        ...
        <div id="content">
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="collapseOne" class="accordion-body collapse in body">
                                   <form  action="<? echo base_url()."tutor/kelas/savenotes"?>" method="POST" enctype="multipart/form-data" class="form-horizontal" id="block-validate">
                                           <?php
				if(isset($msg))
				{ 
			...
			?>
                ...
                <header>
                    ...
                    <h5>Add Asignment</h5>
                   <div class="toolbar">
				    <a href="<?php echo site_url('tutor/kelas/asignment/' .$Id_Class); ?>" class="btn btn-default btn-sm btn-grad btn-rect">List Asignment</a>
                        ...
                        <div class="panel-body">
							...
							<form  action="<? echo base_url()."tutor/kelas/saveasignment"?>" method="POST" enctype="multipart/form-data" class="form-horizontal" id="block-validate">
                                           <?php
				if(isset($msg))
				{ 
					if($msg=='Class successfully add')
			...
			?>
										...
										<div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                <input type="file"  name="userfile" required class="form-control" />
												<input type="hidden"  name="id_class" value="<?php echo $Id_Class;?>" class="form-control" />
												<input type="hidden"  name="id_tutor" value="<?php echo $Id_Tutor;?>" class="form-control" />
                                            </div>
                                        </div>
