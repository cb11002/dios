...
?> 
	<tr> 
		...
		<a href="<?php echo site_url('tutor/kelas/admin_update_status_pending/' .$dg->Id_User.'/'.$dg->User_Type); ?>" class="glyphicon glyphicon-ok" title="Approve">&nbsp;
		<a href="<?php echo site_url('tutor/kelas/admin_update_status_reject/' .$dg->Id_User.'/'.$dg->User_Type); ?>" class="glyphicon glyphicon-remove" title="Reject">
