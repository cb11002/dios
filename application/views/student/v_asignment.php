...
<body class="padTop53 " >
    ...
    <div id="wrap">
        ...
        <!-- END HEADER SECTION -->
		 <?php $this->load->view('student/class_menu');?>
  <!--PAGE CONTENT -->
        <div id="content">
			...
			?>
                                       ...
                                       <div class="form-group">
										...
										<div class="form-group">
                                            <label class="control-label col-lg-4">Tutor</label>
                                            <div class="col-lg-3">
                                                <input type="text"  name="etime" readonly value="<?php echo $Name;?>" class="form-control" />
                                            </div>
                                        </div>
                ...
                <header>
                    ...
                    <h5>List Asignment</h5>
                   <!--<div class="toolbar">
				    <a href="<?php echo site_url('tutor/kelas/form_note/' .$Id_Class); ?>" class="btn btn-default btn-sm btn-grad btn-rect">Add Note</a>
...
?> 
	<tr> 
		<td><?php echo $no++; ?></td>
		<td><?php $oDate = new DateTime($dg->Date_Created_Asign); echo $sDate = $oDate->format("d/m/Y");?></td>
		<td><?php $oDate = new DateTime($dg->Due_Date); echo $sDate = $oDate->format("d/m/Y");?></td>
		<td><?php echo $dg->Title; ?></td>
		
	<td><a href="<?php echo site_url('tutor/kelas/download_asignment/' .$dg->File); ?>"><?php echo $dg->File; ?></a></td>  
		
		<!--<td align="center" width="10">
		
		<a href="<?php echo site_url('tutor/kelas/delete_notes/' .$dg->Id_Note.'/'.$dg->Id_Class); ?>" class="glyphicon glyphicon-remove" title="Delete">
